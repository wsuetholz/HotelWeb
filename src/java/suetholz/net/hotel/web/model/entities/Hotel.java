 ...
 */
package suetholz.net.hotel.web.model.entities;
...
public class Hotel {
    ...
    public Hotel(int hotelId, String hotelName, String streetAddress, String city, String state, String postalCode, String notes) {
